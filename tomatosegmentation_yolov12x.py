# -*- coding: utf-8 -*-
"""TomatoSegmentation_YOLOv12x.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/13tyrYDziRfSNI2oEpN1HUAmMYPDH4_9A
"""
...
!yolo task=segment mode=train model=yolo12x-seg.yaml data='/content/TOMATO-SEGMENTATION-4/data.yaml' epochs=150 imgsz=640 device=0 batch=16 optimizer=auto patience=50 momentum=0.9 weight_decay=0.0005 workers=8
