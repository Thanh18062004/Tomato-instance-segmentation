# -*- coding: utf-8 -*-
"""Tomato Segmentation_YOLOv12n

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/17tazMORNUTIZDnCUWB3LNr-yLFE3Tpjw
"""
...
!yolo task=segment mode=train model=yolo12n-seg.yaml data='/content/TOMATO-SEGMENTATION-4/data.yaml' epochs=150 imgsz=640 device=0 batch=16 optimizer=auto patience=50 momentum=0.9 weight_decay=0.0005 workers=8

from IPython.display import Image

Image("/content/runs/segment/train2/confusion_matrix.png", width=600)

Image("/content/runs/segment/train2/labels.jpg", width=600)

Image("/content/runs/segment/train2/results.png", width=600)

Image("/content/runs/segment/train2/train_batch0.jpg", width=600)

Image("/content/runs/segment/train2/val_batch0_pred.jpg", width=600)
...
predict_folders = glob.glob('/content/runs/segment/predict*/')
